...
from app.froms import LoginForm,RegistrationForm,EditProfileForm,PostForm,CommentForm
...
def index():
    ...
    #context = {
    # 查询数据，摈弃字典
    paginates=Post.query.order_by('timestamp').paginate(page,per_page,error_out=False)
   # }
...
def article(article_id):
    ...
    comments = Comment.query.filter_by(post_id=article_id).all()
    form = CommentForm()
    if form.validate_on_submit():
        body = form.body.data
